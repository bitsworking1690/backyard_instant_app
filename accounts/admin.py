...
from accounts.models import CustomUser, EmailOtp, Role, Permission, Module, BlacklistedToken
...
class CustomUserAdmin(UserAdmin, ImportExportModelAdmin, SimpleHistoryAdmin):
    ...
    list_display = ['id', 'email', 'first_name', 'last_name', 'get_roles', 'gender', 'token']
